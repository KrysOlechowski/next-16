            ...
            <>
              ...
              <div
                ...
                style={{
                  position: "absolute",
                  top: top,
                  left: `${position[0] + randomIntFromInterval(1, 2)}%`,
                  // animationDelay: `${AnimationDuration}ms`,
                  animationDuration: `${AnimationDuration}ms`,
                }}
                className={`fade-in-element`}
              >
                <Image height={size[randomSize]} src={Tree_icon_2} alt="Tree" />
              </div>
            </>
          );
        })}
...
// className={`animate-fade animate-duration-[10000ms] animate-ease-linear animate-reverse animate-infinite`}
